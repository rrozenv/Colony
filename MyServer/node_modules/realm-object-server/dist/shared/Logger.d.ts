...
export declare class Mute extends Logger {
...
export declare class WinstonLogger extends Logger {
    ...
    close(): void;
    add(transportClass: any, params: any): void;
    addConsole(): void;
    addFile(filename: string): void;
}
export declare class Console extends WinstonLogger {
    constructor(level?: string);
}
export declare class File extends WinstonLogger {
    constructor(filename: string, level?: string);
}
export declare class FileConsole extends WinstonLogger {
    constructor(filename?: string, level?: string);
}
